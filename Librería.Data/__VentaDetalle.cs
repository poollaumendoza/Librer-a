...
namespace Librería.Data
{
    ...
    {
        Entidades.__VentaDetalle eVentaDetalle = new Entidades.__VentaDetalle();
        ...
        {
            List<Entidades.__VentaDetalle> oLista = new List<Entidades.__VentaDetalle>();
            ...
            using (SQLiteConnection Cnx = new SQLiteConnection(Settings.Default.CadenaConexion))
            {
                ...
                using (SQLiteDataReader Dr = Cmd.ExecuteReader())
                {
                    while (Dr.Read())
                    {
                        oLista.Add(new Entidades.__VentaDetalle()
                        {
        ...
        public List<Entidades.__VentaDetalle> ListaVentaDetalle(string nombreObjeto, string valor)
        {
            ...
            switch (nombreObjeto)
            {
                ...
                case "IdVenta":
                    ...
                    {
                        Cnx.Open();
                        query = "Select IdVentaDetalle, IdVenta, Cantidad, Descripcion, Precio, Importe, IdEstado from VentaDetalle where IdVenta = @IdVenta";
                        SQLiteCommand Cmd = new SQLiteCommand(query, Cnx);
                        Cmd.Parameters.AddWithValue("@IdVenta", valor);
